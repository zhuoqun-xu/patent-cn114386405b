...
> データベースのテーブル構造と医療データ源を用い、テーブル間の整合性を保つ医療テストデータを生成する特許技術。
...
医療ソフトウェアのテストには、十分な量があり、対象の業務場面に適したデータが必要です。実際の診療記録は機微性が高く、開発者が利用できない場合があります。過去のデータを人手で組み合わせる方法は効率が低く、コストも高くなります。また、量が少ない、または業務場面に合わないデータでは、意図した処理を十分に検証できません。私はこの課題に対し、テーブル情報と利用可能なデータ源から医療テストデータを自動生成する方法を設計しました。
